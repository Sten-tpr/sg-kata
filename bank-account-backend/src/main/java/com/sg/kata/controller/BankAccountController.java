...
public class BankAccountController {
    ...
    @PostMapping("/deposit")
    public ResponseEntity<TransactionDto> deposit(@Valid @RequestBody AmountDto body) {
    ...
    public ResponseEntity<TransactionDto> withdraw(@Valid @RequestBody AmountDto body) {
